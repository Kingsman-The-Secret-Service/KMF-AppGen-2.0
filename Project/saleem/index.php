        ...
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <li class="dropdown '.($indexStatus == "views"? 'active':NULL).'"  role="menu" ><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class=" icon-wrench"></i> View <b class="caret"></b></a>
                    ...
                    <li '.($indexStatusVal == "vp_import_images"? 'class="active"':NULL).'><a tabindex="-1" href="?views=vp_import_images">VP_IMPORT_IMAGES</a></li>
...
if(!empty($_POST) && isset($_POST['saleem'])){
...
$invalid = array_merge(
    (array)KMF_CRUD::createFormData("vp_import_images",$_POST)
    );
...
echo '
    <div class="form-actions">
        ...
        <button type="submit" name="saleem" id="saleem" value="saleem" class="btn btn-medium btn-success">Submit</button>
    </div> 
</form>';   
}
/********** End of Form ************/
