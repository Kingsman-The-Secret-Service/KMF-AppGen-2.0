...
//    echo '</pre>';
    ...
    if($invalid == FALSE){
        ...
        echo (!file_exists(ProjectDIR.$PROJECT) && !file_exists(ProjectDIR.$PROJECT.'/layouts/') && !file_exists(ProjectDIR.$PROJECT.'/forms/') && !file_exists(ProjectDIR.$PROJECT.'/views/'))? "yes":"no";
        echo '</pre>';
